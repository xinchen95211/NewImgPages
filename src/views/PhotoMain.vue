  ...
  <div class="common-layout ">
    ...
    <el-container :class="isDark ? 'darks':''" >
     <tabs-vips @handleSelect="handleSelect" @handleSearch="handleSearch" @toggleDark="toggleDark" :is-dark="isDark"></tabs-vips>
      <el-main><photo-card ref="photoCard" :imglist="imgList" @selectItem="selectItem" @selectStar="selectStar" ></photo-card></el-main>
...
export default {
  ...
  methods:{
    ...
    selectStar(i){
      console.log(this.imgList[i].star)
      this.imgList[i].star = (this.imgList[i].star == 1 ? 0:1);
    },
    //图片加载
    imgListLoad(){
      this.imgList = []
